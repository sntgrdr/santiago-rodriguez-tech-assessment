  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        <h3 className="text-xl font-bold mb-4 text-gray-900">Actualizar Estado: {order.number}</h3>

        {error && (
          <div className="mb-4 p-3 bg-red-50 border-l-4 border-red-500 text-red-700 text-sm">
            <p className="font-bold">Error de transición:</p>
            <p>{error}</p>
          </div>
        )}
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-xs text-gray-500">Estado actual: <span className="font-semibold">{order.status}</span></p>
        </div>
